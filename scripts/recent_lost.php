...
$matchGetter = "SELECT * FROM (SELECT * FROM lmatches WHERE looser = '$search_term'  ORDER BY id DESC LIMIT 3) as r ORDER BY id";
		...
		$showData .= "
					<thead>
					    <tr>
					      ...
					      <th scope='col' class='text-danger'>Looser</th>
